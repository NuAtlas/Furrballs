...
![Figure 1: Hit rate by workload across quantization classes. Integer quantization preserves ScanResistant (~90%) and enables Looping (~49%). Float64 collapses ScanResistant to 48% and scores 0% on Looping. Log8 trades Looping for a marginal Zipfian gain.](fig-quantization.pdf){#fig-quantization fig-align="center"}
