...
subtitle: "Technical Report v1.7.2"
...
## Status
v1.7.2 --- Fix factual error: Set scaling bottleneck is SpinLock (ARC list mutations), not PromoteBuf (read-path deferred promotions)
