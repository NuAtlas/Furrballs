...
- INSERT: CAS ctrl EMPTY → OCCUPIED (h2_short)
...
Set(key, value) -> CMapSetResult{err, inserted}:
  ...
  // Step 3: CAS ctrl (structural claim)
  if !CAS(ctrl[target], EMPTY -> h2_short):
