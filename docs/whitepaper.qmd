...
## Status
**v1.21.0** --- Topology-aware resource placement for asymmetric memory systems. REMARC as unified eviction/migration policy. ARC-FLATLL2 closes the data structure gap (+87--172% over ARC, identical hit rates). ARC-REMARC hybrid experiments confirm REMARC's value is the migration axis, not eviction improvement (Findings 32--34 in REMARC paper). Status section compacted; changelog moved to Appendix C.
