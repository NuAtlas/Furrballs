...
subtitle: "Technical Report v1.8.5"
...
## Status
v1.8.5 --- ARC dimensionality insight: recency (ARC) and locality (Furrballs) are orthogonal axes, page-level ARC as the wholesale eviction mechanism
