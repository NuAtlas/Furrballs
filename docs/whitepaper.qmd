...
subtitle: "Technical Report v1.8.2"
...
## Status
v1.8.2 --- Cross-node migration uses insert-before-erase ordering to eliminate transient miss window (no forwarding mechanism needed)
