...
subtitle: "Technical Report v1.14.0"
...
**Phase 1 is complete.** **Phase 2a is complete.** **Phase 2b data collected but evaluation deferred** (§5.20: page-level eviction smothers policy differentiation).
...
- [ ] ARC-flat variant: same ARC algorithm with flat array layout (isolates data structure from policy)
- [ ] 3-way comparison: ARC-linked vs ARC-flat vs REMARC-flat
