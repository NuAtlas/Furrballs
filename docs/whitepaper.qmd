...
- [ ] REMARC scanner: SSE2 batch scoring of TempCtrl → Evict/Migrate candidates, migration-first execution ordering
- [ ] Cross-node migration: insert-before-erase for M > θ_m candidates, HotNode as target
- [ ] Page eviction: E_page aggregation from per-key scores, page flush to RocksDB for E_page > θ_e
