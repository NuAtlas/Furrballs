...
## Status
**v1.22.0** --- History Atom experiment (REMARC paper §10, Findings 35--38). Pure REMARC atom composition (HA5: 5 atoms on numerical state space) matches or exceeds ARC on 3/4 workloads: Zipfian +20pp, Temporal +16pp, Looping +96pp. Confidence-weighted projection resolves prediction inversion. REMARC paper v0.11.0. PolicyBench now includes 36 variants (4 History Atom + BUG-ADAPT-FLAT hang fix + REMARC-1L/2L lazy buckets). Production per-key eviction not yet smoke-tested.
