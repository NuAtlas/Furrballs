...
subtitle: "Technical Report v1.7.1"
...
## Status
v1.7.1 --- Review fixes: baseline Get presentation corrected, interleave validation added, ablation per-iteration stddev quantified (Step D stddev=3.8%)
