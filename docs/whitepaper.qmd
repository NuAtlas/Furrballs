...
subtitle: "Technical Report v1.24.0"
...
## Status
**v1.24.0** --- CRITICAL CORRECTION to REMARC paper references. REMARC paper v0.13.0 retracts Sections 10-11 and principal results 7-8 due to score degeneracy and sentinel bug (see REMARC paper Section 12). All HA-family hit rates cited below (55% Zipfian, 83-98% ScanRes/Looping) are artifacts. Genuine HA performance is LRU-equivalent (~25% Zipfian). History Atom experiment remains documented as a thorough negative finding. PolicyBench sentinel bug fixed in all 24 affected variants. New variant HA-LOGLIN-FRESH validates genuine scoring.
...
| Version | Summary |
|---------|---------|
| v1.24.0 | REMARC paper v0.13.0 critical correction. Sentinel bug + score degeneracy invalidate HA hit rates (§10-11). New §12. Whitepaper REMARC references corrected. |
| v1.22.0 | History Atom experiment (REMARC paper §10, Findings 35--38). [Retracted v0.13.0: hit rates were artifact-based.] REMARC paper v0.11.0. PolicyBench 36 variants. |
