...
## Status
v1.11.0 --- REMARC policy framework paper (v0.7.0, DOI: 10.5281/zenodo.19794758) complete with 24 variants (including QuotaFree baseline), 30 findings, AUG-ADAPT self-tuning feedback controller. PolicyBench simulation harness. Whitepaper updated with REMARC citation, engineering decisions, variant taxonomy.
